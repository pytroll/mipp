...
project = u'MIPP'
copyright = u'2013, Lars Ørum Rasmussen and the Pytroll crew'
...
latex_documents = [
  ('index', 'mipp.tex', u'MIPP Documentation',
   u'Lars Ørum Rasmussen', 'manual'),
]
...
man_pages = [
    ('index', 'mipp', u'MIPP Documentation',
     [u'Lars Rasmussen'], 1)
]
